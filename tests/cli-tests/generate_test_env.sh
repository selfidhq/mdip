...
KC_GATEKEEPER_TRUST_PROXY=false
KC_GATEKEEPER_RATE_LIMIT_ENABLED=false
KC_GATEKEEPER_RATE_LIMIT_WINDOW_VALUE=1
KC_GATEKEEPER_RATE_LIMIT_WINDOW_UNIT=minute
KC_GATEKEEPER_RATE_LIMIT_MAX_REQUESTS=600
KC_GATEKEEPER_RATE_LIMIT_WHITELIST=
KC_GATEKEEPER_RATE_LIMIT_SKIP_PATHS=/api/v1/ready
...
KC_KEYMASTER_TRUST_PROXY=false
KC_KEYMASTER_RATE_LIMIT_ENABLED=false
KC_KEYMASTER_RATE_LIMIT_WINDOW_VALUE=1
KC_KEYMASTER_RATE_LIMIT_WINDOW_UNIT=minute
KC_KEYMASTER_RATE_LIMIT_MAX_REQUESTS=600
KC_KEYMASTER_RATE_LIMIT_WHITELIST=
KC_KEYMASTER_RATE_LIMIT_SKIP_PATHS=/api/v1/ready

# Search Server
KC_SEARCH_SERVER_PORT=4002
KC_SEARCH_SERVER_GATEKEEPER_URL=http://gatekeeper:4224
KC_SEARCH_SERVER_REFRESH_INTERVAL_MS=5000
KC_SEARCH_SERVER_DB=sqlite
KC_SEARCH_SERVER_POSTGRES_URL=
KC_SEARCH_SERVER_TRUST_PROXY=false
KC_SEARCH_SERVER_RATE_LIMIT_ENABLED=true
