const config = {
    ...
    moduleNameMapper: {
        ...
        '^@mdip/ipfs/kubo$': '<rootDir>/packages/ipfs/src/kubo-client.ts',
        ...
        '^@noble/hashes/sha2(?:\\.js)?$': '<rootDir>/tests/common/noble-sha2.mock.ts',
        '^@noble/hashes/utils(?:\\.js)?$': '<rootDir>/tests/common/noble-hashes-utils.mock.ts',
