const config = {
    ...
    moduleNameMapper: {
        ...
        '^\\.\\/db\\/(sqlite|postgres)\\.js$': '<rootDir>/services/mediators/hyperswarm/src/db/$1.ts',
        '^\\.\\/negentropy\\/(adapter|protocol|policy|observability|transfer|cursor|windows)\\.js$': '<rootDir>/services/mediators/hyperswarm/src/negentropy/$1.ts',
        ...
        '^\\.\\/peer-directory\\.js$': '<rootDir>/services/mediators/hyperswarm/src/peer-directory.ts',
        '^\\.\\/queue-coordinator\\.js$': '<rootDir>/services/mediators/hyperswarm/src/queue-coordinator.ts',
